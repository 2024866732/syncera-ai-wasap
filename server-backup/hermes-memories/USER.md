...
§
§
Preferences: Audit-first, approval-gated workflow. Official WhatsApp Cloud API only. Hybrid Azure+Oracle architecture. Don't deploy to production without explicit approval.